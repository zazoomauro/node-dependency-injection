...
class ContainerBuilder {
  ...
  _getInstance (id, bypassPublic = false) {
    ...
    if (this._container.has(id) && ((definition.public) || (!bypassPublic && definition.public))) {
  ...
  setParameter (key, value) {
    if (typeof value !== 'string' && !Array.isArray(value) && typeof value !== 'boolean') {
      throw new TypeError('The expected value is not a flat string, an array or boolean')
    }
