...
class Definition {
  ...
  constructor (Object = null, args = [], overrideArgs = []) {
    ...
    this._whenMissing = null
    this._whenServiceExists = null
    this._keyedGroup = null
    this._keyedKey = null
    this._keyedDefault = false
  }
   ...
   */
  get keyedGroup () {
    return this._keyedGroup
  }

  /**
   * @param {string|null} value
   */
  set keyedGroup (value) {
    this._keyedGroup = value
  }
   ...
   */
  get keyedDefault () {
    return this._keyedDefault
  }

  /**
   * @param {boolean} value
   */
  set keyedDefault (value) {
    this._keyedDefault = value
  }
   ...
   */
  get whenMissingId () {
    return this._whenMissing
  }

  /**
   * @returns {string|null}
   */
  get whenServiceExistsId () {
    return this._whenServiceExists
  }

  /**
   * Set a phase-one condition that must pass for this service to be registered.
   * Conditions are evaluated during compile().
   *
  ...
  /**
   * Register this service only if no service with the given id is already registered.
   * Evaluated in phase two of condition processing (after env/custom conditions).
   *
   * @param {string} id
   * @returns {Definition}
   */
  whenMissing (id) {
    this._whenMissing = id
    return this
  }

  /**
   * Register this service only if a service with the given id is registered.
   * Evaluated in phase two of condition processing (after env/custom conditions).
   *
   * @param {string} id
   * @returns {Definition}
   */
  whenServiceExists (id) {
    this._whenServiceExists = id
    return this
  }
}
