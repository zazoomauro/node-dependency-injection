...
export default class XmlFileLoader extends FileLoader {
  ...
  _transformDefaults (defaultsNode) {
    ...
    if (defaultsNode['@_autowireAliasResolution'] !== undefined) {
      defaults.autowireAliasResolution = defaultsNode['@_autowireAliasResolution']
    }
    ...
    if (defaultsNode['@_dumpFile'] !== undefined) {
      defaults.dumpFile = defaultsNode['@_dumpFile']
    }
  ...
  _transformService (svc) {
    ...
    if (svc.keyed) {
      service.keyed = {
        group: svc.keyed['@_group'],
        key: svc.keyed['@_key'],
        default: svc.keyed['@_default'] === 'true' || svc.keyed['@_default'] === true
      }
    }
