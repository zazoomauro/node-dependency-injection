...
import MissingDependencies from '../../../Resources-ts/MissingDependencies'
import SyntheticService from '../../../Resources-ts/SyntheticService'
import Listener from '../../../Resources-ts/Listener'
import DecoratingMailer from '../../../Resources-ts/DecoratingMailer'
import Mailer from '../../../Resources-ts/Mailer'
import DecoratingMailerTwo from '../../../Resources-ts/DecoratingMailerTwo'
...
describe('YamlFileLoaderTS', () => {
  ...
  describe('load with main', () => {
    ...
    it('should load instance of service with tagged arguments', async () => {
      ...
      const configPath = path.join(
        __dirname,
        '/../../../Resources-ts/config/tagged-arguments.yml'
      )
    ...
    it('should load class from package without errors', async () => {
      ...
      const configPath = path.join(
        __dirname,
        '/../../../Resources-ts/config/service_from_package.yml'
      )
