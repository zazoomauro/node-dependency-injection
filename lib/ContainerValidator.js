...
export default class ContainerValidator {
   ...
   */
  _serviceExists (id) {
    return this._container.definitions.has(id) ||
      this._container.hasAlias(id) ||
      (id === 'service_container' && this._container.containerReferenceAsService)
  }
  ...
  _resolveAlias (id) {
    ...
    if (!definitions.has(id) && alias && alias.has(id)) {
      return alias.get(id)
    }
    return id
  }
